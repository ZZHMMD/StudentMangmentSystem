...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" align="center">成绩增加</h1>
			</div>
		</div><!--/.row-->
		<div align="center">
		<form action="${pageContext.request.contextPath}/GradeServlet?op=add" method="post">
		    <table>
		    <tr>
		        <td><label class="lb-control">I&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D:</label></td>
		        <td><input name="id" type="text" value="${grade.studentid }"></td>
		    <tr>
		        <td><label class="lb-control">学	&nbsp;号:</label></td>
		        <td><input name="studentid" type="text" value="${grade.studentid }"></td>
		    </tr>
		    <tr>
