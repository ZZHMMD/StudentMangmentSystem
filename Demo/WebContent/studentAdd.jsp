...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" align="center">学籍添加</h1>
			</div>
		</div><!--/.row-->
		<div align="center">
		<form action="${pageContext.request.contextPath}/StudentServlet?op=add" method="post">
		    <table>
		    <tr>
		    ...
		    <tr>
		        ...
		        <td><input  name="indate" type="text" id="time" class="date_calendar"></td>
		    </tr>
		    <tr>
