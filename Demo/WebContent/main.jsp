...
<input type="hidden" id="pagecount" value="${page.pagecount}">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
						...
						<div class="row">
							...
							<div class="col-sm-5" >
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="major" id="major"  placeholder="主修专业" class="form-control">
									</div>
        ...
        <td width="60%">
            <a href="${pageContext.request.contextPath }/StudentServlet?op=page&currentPageIndex=${pageAll.currentPageIndex -1}" style="text-decoration:none;">|&lt;</a>
            <c:forEach begin="${startIndex}" end="${endIndex }" var="n">
                <a href="${pageContext.request.contextPath }/StudentServlet?op=page&currentPageIndex=${n}">${pageAll.currentPageIndex == n ?"<font color=red>":"<font>"}${n }</font></a>
            </c:forEach>
            <a href="${pageContext.request.contextPath }/StudentServlet?op=page&currentPageIndex=${pageAll.currentPageIndex +1}" style="text-decoration:none;">&gt;|</a>
        </td>
        <td width="10%">
            <input type="text" value="${pageAll.currentPageIndex }" name="currentPageIndex" size="2" id="pageindex">&nbsp;<a href="javascript:aJump()">跳转</a>
        </td>
        <td width="10%">
	...
	function delmore(){
		...
		confirm("是否删除被选中学生学籍?","删除学籍将无法恢复!",function (isConfirm) {
            if (isConfirm) {
            	...
            	//将数据传递到服务端进行删除
            	window.location = "${pageContext.request.contextPath }/StudentServlet?op=delmore&ids="+s+"&currentPageIndex=${pageAll.currentPageIndex}";
	 ...
	 $(".delete_a").on('click',function(){
		     ...
		     var url="StudentServlet?op=delete&currentPageIndex=${pageAll.currentPageIndex}&id="+id;
	...
	function aJump(index){
    	...
    	window.location.href="${pageContext.request.contextPath }/StudentServlet?op=page&currentPageIndex="+index+"&currentPageIndex=${pageAll.currentPageIndex}";
    }
